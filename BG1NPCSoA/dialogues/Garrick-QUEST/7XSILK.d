...
IF ~Global("SILKEQUEST","LOCALS",0)InParty("7XGAR")!StateCheck("7XGAR",CD_STATE_NOTVALID)~ THEN BEGIN SILKE1
SAY @0
IF ~InParty("7XGAR")!StateCheck("7XGAR",CD_STATE_NOTVALID)~ THEN EXTERN ~7XGarJ~ GarrickWhat
END

IF ~~ THEN BEGIN GarrickSILKE2
SAY @1
IF ~InParty("7XGAR")!StateCheck("7XGAR",CD_STATE_NOTVALID)~ THEN EXTERN ~7XGarJ~ GarrickWhat2
END
...
SAY @5
IF ~InParty("7XGAR")!StateCheck("7XGAR",CD_STATE_NOTVALID)~ THEN EXTERN ~7XGarJ~ GarrickWhat3
END
...
IF ~Global("SILKEQUEST","LOCALS",1)~ THEN BEGIN SILKEohoh
SAY @8
=
@9
IF ~~ THEN EXIT
