...
IF WEIGHT #-99~Global("SkieARbgx2","GLOBAL",1)AreaCheck("ARbgx2")~ THEN BEGIN WaterGardensSneak0
SAY @1
=
@2
...
IF ~Global("SkieIsTalking","GLOBAL",0)~ THEN BEGIN SkieFirstTalk
SAY @12
=
@13 
...
SAY @16
IF ~~THEN DO ~SetGlobal("SkieIsTalking","GLOBAL",2)~ EXIT
END
...
=
@19
IF~~THEN REPLY @20 GOTO Skie01x02
...
SAY @22
IF~~THEN REPLY @23 GOTO Skie01x04
IF~~THEN REPLY @24 GOTO Skie01x04
END
...
IF ~Global("SkieIsTalking","GLOBAL",2)~ THEN BEGIN SKIEPC_New1
SAY @26
=
@27
...
IF ~Global("SkieIsTalking","GLOBAL",3)~ THEN BEGIN Skie-PC-Banter1
SAY @42
=
@43
IF~~THEN REPLY @44 DO ~SetGlobal("SkieIsTalking","GLOBAL",3)~ GOTO Skie-PC-Banter2
...
IF ~Global("SkieIsTalking","GLOBAL",4)~ THEN BEGIN SkiePCTalk4
SAY @62
=
@63
...
== BNALIA @84 
== 7XSkiB @85 
DO ~SetGlobal("NaliaSkieKeepBanter","GLOBAL", 2)~
EXIT


CHAIN
IF WEIGHT #-99~InParty("Edwin")See("Edwin")
GENDER("Edwin",FEMALE)!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
CHAIN
IF WEIGHT #-99~AreaCheck("AR2200")InParty("Imoen2")IsValidForPartyDialog("Imoen2")!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")~ THEN ~7XSkiB~ SkieJahAR0509
@116 
...
CHAIN
IF  WEIGHT #-99 ~AreaCheck("AR0701")Global("SkieMinscBanter701","GLOBAL",0)!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
See("Jaheira")!StateCheck("Jaheira",CD_STATE_NOTVALID)!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")~ THEN ~7XSkiB~ SkieJahAR2007
@138
=
@139 
...
CHAIN
IF WEIGHT #-99~InParty("Cernd")!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
See("Cernd")
OR(2)
AreaType(FOREST)
AreaCheck("AR1900")
...
CHAIN
IF WEIGHT #-99 ~AreaCheck("AR2100")Global("SkieJaheiraAR2100","GLOBAL",0)!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
See("Imoen2")
!StateCheck("Imoen2",CD_STATE_NOTVALID)!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
Global("SkieHaerDalis","GLOBAL",0)~ THEN ~7XSkiB~ HaerDalisSkie1
...
IF ~InParty("Minsc")
See("Minsc")
!StateCheck("Minsc",CD_STATE_NOTVALID)!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
IF ~InParty("Valygar")
See("Valygar")
!StateCheck("Valygar",CD_STATE_NOTVALID)!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
InParty("Keldorn")!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
CHAIN
IF ~InParty("Jaheira")
See("Jaheira")!StateCheck("Jaheira",CD_STATE_NOTVALID)!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
See("HaerDalis")
!StateCheck("HaerDalis",CD_STATE_NOTVALID)!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
CHAIN
IF ~InParty("Edwin")!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
IF ~InParty("Yoshimo")
See("Yoshimo")
!StateCheck("Yoshimo",CD_STATE_NOTVALID)!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
CHAIN
IF ~InParty("Aerie")
See("Aerie")!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
CHAIN
IF ~InParty("Viconia")
See("Viconia")!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
CHAIN IF
~InParty("Korgan")IsValidForPartyDialog("Korgan")!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
...
CHAIN IF
~!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI") !Dead("7XSKI")IsValidForPartyDialog("Mazzy")
...
CHAIN
IF ~InParty("Edwin")!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")
See("Edwin")!StateCheck ("Edwin", CD_STATE_NOTVALID)Global("EdwinSkieTalk","GLOBAL",1)~ THEN ~7XSkiB~ EdwinSkie2
@349
...
CHAIN IF
~!StateCheck("7XSKI",CD_STATE_NOTVALID)InParty("7XSKI")InParty("Korgan")IsValidForPartyDialog("Korgan")
