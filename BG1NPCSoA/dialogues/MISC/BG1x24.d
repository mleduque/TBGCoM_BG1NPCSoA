...
IF ~InParty("7XGAR")
Global("GarrickGirls","GLOBAL",2)~ THEN BEGIN 22GARRICKBANTERAFTERMATH
SAY @12
IF ~~ THEN EXIT
END
...
Global("GarrickGirls","GLOBAL",1)~ THEN BEGIN 22GARRICKBANTER2
SAY @13
=
@14
IF ~~ THEN EXIT
...
IF ~AreaCheck("arBGX4")!InParty("7XGAR")OR(3)Global("GarrickGirls","GLOBAL",2)Global("GarrickGirls","GLOBAL",1)
...
IF ~AreaCheck("arBGX4")!InParty("7XGAR")OR(3)Global("GarrickGirls","GLOBAL",2)Global("GarrickGirls","GLOBAL",1)
Global("GarrickGirls","GLOBAL",0)RandomNum(3,2)~ THEN BEGIN BlueUnicorn2
SAY @17
=
@18
=
...
IF ~AreaCheck("arBGX4")!InParty("7XGAR")OR(3)Global("GarrickGirls","GLOBAL",2)Global("GarrickGirls","GLOBAL",1)
Global("GarrickGirls","GLOBAL",0)RandomNum(3,3)~ THEN BEGIN BlueUnicorn3
SAY @23
=
@24
=
...
IF ~AreaCheck("arBGX2")!InParty("7XGAR")OR(3)Global("GarrickGirls","GLOBAL",2)Global("GarrickGirls","GLOBAL",1)
Global("GarrickGirls","GLOBAL",0)RandomNum(3,1)~ THEN BEGIN 22SHOOSHOOxxxx
SAY @29
=
@30 
IF ~~ THEN EXIT
...
IF ~AreaCheck("arBGX2")!InParty("7XGAR")OR(3)Global("GarrickGirls","GLOBAL",2)Global("GarrickGirls","GLOBAL",1)
Global("GarrickGirls","GLOBAL",0)RandomNum(3,2)~ THEN BEGIN 22SHOOSHOO2
SAY @31
=
@32
=
...
IF ~AreaCheck("arBGX2")!InParty("7XGAR")OR(3)Global("GarrickGirls","GLOBAL",2)Global("GarrickGirls","GLOBAL",1)
Global("GarrickGirls","GLOBAL",0)RandomNum(3,3)~ THEN BEGIN 22SHOOSHOO3
SAY @38
=
@39
=
...
IF ~InParty("7XGAR")
Global("GarrickGirls","GLOBAL",2)~ THEN BEGIN 23GARRICKBANTERAFTERMATH
SAY @44
=
@45
IF ~~ THEN EXIT
...
OR(2)
Global("GarrickGirls","GLOBAL",0)
Global("GarrickGirls","GLOBAL",1)~ THEN BEGIN 23GARRICKBANTER2
SAY @46
=
@47
IF ~~ THEN EXIT
...
IF ~AreaCheck("arBGX2")!InParty("7XGAR")OR(3)Global("GarrickGirls","GLOBAL",0)Global("GarrickGirls","GLOBAL",2)
Global("GarrickGirls","GLOBAL",1)RandomNum(4,1)~ THEN BEGIN 23GARRICKBANTER223SHOOSHOO
SAY @55
=
@56
IF ~~ THEN EXIT
...
IF ~AreaCheck("arBGX2")!InParty("7XGAR")OR(3)Global("GarrickGirls","GLOBAL",0)Global("GarrickGirls","GLOBAL",2)
Global("GarrickGirls","GLOBAL",1)RandomNum(4,2)~ THEN BEGIN 23GARRICKBANTER223SHOOSHOO2
SAY @57 
=
@58
IF ~~ THEN EXIT
...
IF ~AreaCheck("arBGX2")!InParty("7XGAR")OR(3)Global("GarrickGirls","GLOBAL",0)Global("GarrickGirls","GLOBAL",2)
Global("GarrickGirls","GLOBAL",1)RandomNum(4,3)~ THEN BEGIN 23GARRICKBANTER223SHOOSHOO3
SAY @59
=
@60
IF ~~ THEN EXIT
...
IF ~AreaCheck("arBGX2")!InParty("7XGAR")OR(3)Global("GarrickGirls","GLOBAL",0)Global("GarrickGirls","GLOBAL",2)
Global("GarrickGirls","GLOBAL",1)RandomNum(4,4)~ THEN BEGIN 23GARRICKBANTER223SHOOSHOO4
SAY @61
=
@5
=
...
APPEND BG1X24
IF WEIGHT #-1~AreaCheck("arBGX2")OR(2)
IsGabber("7XGAR")
InParty("7XGAR")
!StateCheck("7XGAR",CD_STATE_NOTVALID)InMyArea("FARTHIN")InMyArea("FULADY")InMyArea("BG1X9")
...
APPEND BG1X24
IF WEIGHT #-1~InParty("7XGAR")IsValidForPartyDialog("7XGAR")AreaCheck("arBGX2")InMyArea("FARTHIN")InMyArea("FULADY")InMyArea("BG1X9")
...
APPEND BG1X24
IF WEIGHT #-1~!InParty("7XGAR")InParty("Haer'Dalis")
See("Haer'Dalis")
!StateCheck("Haer'Dalis",STATE_SLEEPING)AreaCheck("arBGX2")
...
Global("AerieRomanceActive","GLOBAL",0)~ THEN @213
==  HAERDAJ IF ~IsValidForPartyDialog("Aerie")
Global("HaerDalisRomanceActive","GLOBAL",2)
OR(2)
Global("AerieRomanceActive","GLOBAL",3)
Global("AerieRomanceActive","GLOBAL",0)~ THEN @214
...
=
@355 
IF ~~ THEN REPLY @349 DO
~StartStore("BG1NPC6",LastTalkedToBy())~ EXIT
