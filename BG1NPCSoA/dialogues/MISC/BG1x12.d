...
IF ~Global("7xBorivykMonkeyQuest","GLOBAL",2)~ THEN DO ~AddJournalEntry(@1814,QUEST_DONE) AddexperienceParty(2000)~ REPLY @176 GOTO 7xBorivykTalkMonkeyHeal // MONKEY POTION
IF ~!Global("7xBorivykMonkeyQuest","GLOBAL",1) !Global("7xBorivykMonkeyQuest","GLOBAL",2) RandomNum(6,1)~ THEN REPLY @108 GOTO 7xBorivykTalkMonkey1 // MONKEY
IF ~!Global("7xBorivykMonkeyQuest","GLOBAL",1) !Global("7xBorivykMonkeyQuest","GLOBAL",2) RandomNum(6,2)~ THEN REPLY @108 GOTO 7xBorivykTalkMonkey2
IF ~!Global("7xBorivykMonkeyQuest","GLOBAL",1) !Global("7xBorivykMonkeyQuest","GLOBAL",2) RandomNum(6,3)~ THEN REPLY @108 GOTO 7xBorivykTalkMonkey3
IF ~!Global("7xBorivykMonkeyQuest","GLOBAL",1) !Global("7xBorivykMonkeyQuest","GLOBAL",2) RandomNum(6,4)~ THEN REPLY @108 GOTO 7xBorivykTalkMonkey4
IF ~!Global("7xBorivykMonkeyQuest","GLOBAL",1) !Global("7xBorivykMonkeyQuest","GLOBAL",2) RandomNum(6,5)~ THEN REPLY @108 GOTO 7xBorivykTalkMonkey5
IF ~!Global("7xBorivykMonkeyQuest","GLOBAL",1) !Global("7xBorivykMonkeyQuest","GLOBAL",2) RandomNum(6,6)~ THEN REPLY @108 GOTO 7xBorivykTalkMonkey6
IF ~~ THEN REPLY @109 EXIT // EXIT
END
...
SAY @177
=@178
IF ~OR(2) !InParty("DEEKIN") StateCheck("DEEKIN",CD_STATE_NOTVALID)~ THEN DO ~AddJournalEntry(@1814,QUEST_DONE) SetGlobal("7xBorivykMonkeyQuest","GLOBAL",3)~ EXIT
IF ~InParty("DEEKIN") !StateCheck("DEEKIN",CD_STATE_NOTVALID)~ THEN DO ~AddJournalEntry(@1814,QUEST_DONE) SetGlobal("7xBorivykMonkeyQuest","GLOBAL",3)~ EXTERN DEEKINJ 7xBorivykTalkMonkeyDeekin
END
