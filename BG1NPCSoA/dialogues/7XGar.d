...
// Forest
IF WEIGHT #-90 ~Global("GarrickPCTalkForest","LOCALS",2) RealGlobalTimerExpired("GarrickPCTalkForestTimer","GLOBAL")~ THEN BEGIN GarrickPCTalkForest1
SAY @640
=@641
IF ~~ THEN REPLY @642 DO ~SetGlobal("GarrickPCTalkForest","LOCALS",3)~ GOTO GarrickPCTalkForest1_1
IF ~~ THEN REPLY @643 DO ~SetGlobal("GarrickPCTalkForest","LOCALS",3)~ GOTO GarrickPCTalkForest1_2
IF ~~ THEN REPLY @644 DO ~SetGlobal("GarrickPCTalkForest","LOCALS",3)~ GOTO GarrickPCTalkForest1_3
END
...
=
@264 
++ @265 DO ~RealSetGlobalTimer("GarrickPCTalkTimer","GLOBAL",2000)~ GOTO GarrickPCTalk2Irlana4
...
Global("GarrickPCAtkhatla","LOCALS",1)~ THEN BEGIN GarrickPCTalkAthkatla
SAY @347
IF ~~ THEN DO ~SetGlobal("GarrickPCAtkhatla","LOCALS",2) ActionOverride(Player1,SetDialog("PLAYER1"))~ REPLY @348 GOTO GarrickPCTalkAthkatla1
IF ~~ THEN DO ~SetGlobal("GarrickPCAtkhatla","LOCALS",2) ActionOverride(Player1,SetDialog("PLAYER1"))~ REPLY @349 GOTO GarrickPCTalkAthkatla1
IF ~~ THEN DO ~SetGlobal("GarrickPCAtkhatla","LOCALS",2) ActionOverride(Player1,SetDialog("PLAYER1"))~ REPLY @350 GOTO GarrickPCTalkAthkatla2
IF ~~ THEN DO ~SetGlobal("GarrickPCAtkhatla","LOCALS",2) ActionOverride(Player1,SetDialog("PLAYER1"))~ REPLY @351 GOTO GarrickPCTalkAthkatla3
IF ~~ THEN DO ~SetGlobal("GarrickPCAtkhatla","LOCALS",2) ActionOverride(Player1,SetDialog("PLAYER1"))~ REPLY @352 GOTO GarrickPCTalkAthkatla4
IF ~~ THEN DO ~SetGlobal("GarrickPCAtkhatla","LOCALS",2) ActionOverride(Player1,SetDialog("PLAYER1"))~ REPLY @353 GOTO GarrickPCTalkAthkatla5
IF ~~ THEN DO ~SetGlobal("GarrickPCAtkhatla","LOCALS",2) ActionOverride(Player1,SetDialog("PLAYER1"))~ REPLY @354 GOTO GarrickPCTalkAthkatla6
IF ~~ THEN DO ~SetGlobal("GarrickPCAtkhatla","LOCALS",2) ActionOverride(Player1,SetDialog("PLAYER1"))~ REPLY @355 GOTO GarrickPCTalkAthkatla7
END
...
// Garrick - PC (Bodhi)
IF WEIGHT #-30 ~Global("GarrickPCBodhiTalk","LOCALS",1) !Global("GarrickNaliaRomance","GLOBAL",2)~ THEN BEGIN GarrickPCBodhiTalk
SAY @383
=@384
IF ~~ THEN DO ~SetGlobal("GarrickPCBodhiTalk","LOCALS",2)~ REPLY @385 GOTO GarrickPCBodhiTalk1
IF ~~ THEN DO ~SetGlobal("GarrickPCBodhiTalk","LOCALS",2)~ REPLY @386 GOTO GarrickPCBodhiTalk2
IF ~~ THEN DO ~SetGlobal("GarrickPCBodhiTalk","LOCALS",2)~ REPLY @387 GOTO GarrickPCBodhiTalk3
END

IF WEIGHT #-30 ~Global("GarrickPCBodhiTalk","LOCALS",1) Global("GarrickNaliaRomance","GLOBAL",2)~ THEN BEGIN GarrickPCBodhiTalkRomance
SAY @383
=@391
IF ~~ THEN DO ~SetGlobal("GarrickPCBodhiTalk","LOCALS",2)~ REPLY @385 GOTO GarrickPCBodhiTalk1
IF ~~ THEN DO ~SetGlobal("GarrickPCBodhiTalk","LOCALS",2)~ REPLY @386 GOTO GarrickPCBodhiTalk2
...
IF ~~ THEN DO ~SetGlobal("GarrickFriendship","GLOBAL",6)~ REPLY @418 GOTO GarrickPCTalk6l
END
...
// Garrick's quest
IF WEIGHT #-30 ~GlobalTimerExpired("GarrickQuestTalkTimer","GLOBAL")  Global("GarrickBardQuest","GLOBAL",1)~ THEN BEGIN GarrickQuestTalkFirst
SAY @472
...
SAY @633
=@634
IF ~~ THEN REPLY @635 GOTO GarrickQuestGaribTalkFinal3
IF ~~ THEN REPLY @636 GOTO GarrickQuestGaribTalkFinal3
END
...
SAY @632
IF ~~ THEN REPLY @628 EXTERN 7XGar GarrickQuestGaribTalkFinal1
IF ~~ THEN REPLY @630 EXTERN 7XGar GarrickQuestGaribTalkFinal2
END
...
IF WEIGHT #-20 ~Global("GarrickBardQuest","GLOBAL",12) OR(3) !InParty("Nalia") !InMyArea("Nalia") StateCheck("Nalia",CD_STATE_NOTVALID) !Global("GarrickNaliaRomance","GLOBAL",2)~ THEN BEGIN GarrickQuestGaribTalkFinalnoNalia
SAY @627
...
IF ~Dead("7Xgarib") Global("GarrickBardQuest","GLOBAL",14)~ THEN BEGIN GarrickQuestGaribTalkInnGaribDead
SAY @625
IF ~~ THEN DO ~SetGlobal("GarrickBardQuest","GLOBAL",12)~ EXIT
END
...
APPEND 7XGarJ
IF ~Global("RoenalConvict","GLOBAL",1) Global("GarrNaliaSave","LOCALS",1)~ THEN BEGIN GarrickNaliaRejoin
SAY @688
IF ~~ THEN DO ~SetGlobal("GarrNaliaSave","LOCALS",1)~ EXTERN NALIAJ GarrickNaliaRejoin1
END
END
